	     ...
	     add.addActionListener(new ActionListener()
	     {
			...
			public void actionPerformed(ActionEvent arg0)
			{
				...
				add1.addActionListener(new ActionListener()
				{
					...
					@Override
					public void actionPerformed(ActionEvent e) //inserting values into transaction table
					{
						try {
				...
				display.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e)
					{
						...
						link.setBounds(10,20,10,15);
						
						JLabel l1=new JLabel("ProductID");
						l1.setBounds(30,25,150,30);
						...
						f2.add(l1);f2.add(l2);f2.add(l3);f2.add(l4);f2.add(l5);f2.add(link);
